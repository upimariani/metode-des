<div class="container-fluid">
	<div class="container-fluid">
		<div class="card">
			<div class="card-body">
				<h5 class="card-title fw-semibold mb-4">Laporan Peramalan Per Umur</h5>
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url('KepalaPuskesmas/claporanUmur/cetak') ?>" method="POST">
							<div class="mb-3">
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Tahun Kelahiran</label>
								<select class="form-control" name="thn" required>
									<option value="">---Pilih Tahun Kelahiran---</option>
									<option value="1975">1975 - 2005</option>
									<option value="2006">2006 - 2022</option>
								</select>
							</div>
