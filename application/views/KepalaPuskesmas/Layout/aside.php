...
<head>
	...
	<title>KEPALA PUSKESMAS | PUSKESMAS DTP TALAGA</title>
				...
				<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= base_url('KepalaPuskesmas/cLaporanPenyakit') ?>" aria-expanded="false">
								<span>
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= base_url('KepalaPuskesmas/cLaporanDesa') ?>" aria-expanded="false">
								<span>
									<i class="ti ti-list"></i>
								</span>
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= base_url('KepalaPuskesmas/cLaporanJk') ?>" aria-expanded="false">
								<span>
									<i class="ti ti-list"></i>
								</span>
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?= base_url('KepalaPuskesmas/cLaporanUmur') ?>" aria-expanded="false">
								<span>
									<i class="ti ti-list"></i>
								</span>
								<span class="hide-menu">Umur</span>
							</a>
						</li>
						<li class="nav-small-cap">
							<i class="ti ti-dots nav-small-cap-icon fs-4"></i>
