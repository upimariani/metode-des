							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="border-bottom-0">
											<a href="<?= base_url('RekamMedis/cAnalisisPerJk/analisis/' . $value->alamat . '/P')  ?>" class="btn btn-success">View JK Perempuan</a>
											<a href="<?= base_url('RekamMedis/cAnalisisPerJk/analisis/' . $value->alamat . '/L')  ?>" class="btn btn-warning">View JK Laki - Laki</a>
										</td>
									</tr>
								<?php
								}
