						...
						<table class="table text-nowrap mb-0 align-middle">
							<thead class="text-dark fs-4">
								<tr>
									...
									<th class="border-bottom-0">
										<h6 class="fw-semibold mb-0">Ahli Dokter</h6>
									</th>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="border-bottom-0">
											<h6 class="fw-semibold mb-1"><img style="width: 150px;" src="<?= base_url('asset/foto-dokter/' . $value->foto) ?>"></h6>
											<span class="fw-normal"><?= $value->nama_dokter ?></span>
										</td>
										<td class="border-bottom-0">
											<p class="mb-0 fw-normal"><?= $value->ahli_dokter ?></p>
										</td>
										<td class="border-bottom-0">
										...
										<td class="border-bottom-0">
											<h6 class="fw-semibold mb-0 fs-4">
												<a href="<?= base_url('Admin/cDokter/delete/' . $value->id_dokter) ?>" class="btn btn-danger m-1">Hapus</a>
